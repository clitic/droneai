...
- **Image tab** — upload an image, adjust confidence, view detections
- **Video tab** — upload a video, see per-frame progress, get annotated output

## Project Structure

```
droneai/
├── main.py           # Gradio web UI for detection
├── train.py          # YOLO26 training script
├── data.py           # Dataset unification script
├── pyproject.toml    # Dependencies & config
├── data/
│   ├── unified/      # Merged dataset (generated by data.py)
│   └── *.yolo26/     # Raw source datasets
└── runs/
    └── drone_detect/ # Training outputs & weights
```

## Tech Stack

- **[YOLO26](https://docs.ultralytics.com)** — NMS-free, edge-first object detection
- **[Gradio](https://gradio.app)** — Web UI
- **[PyTorch](https://pytorch.org)** — With CUDA 12.6 for GPU acceleration
